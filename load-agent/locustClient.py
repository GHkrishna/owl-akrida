...
VERIFIED_TIMEOUT_SECONDS = int(os.getenv("VERIFIED_TIMEOUT_SECONDS", default=20))
...
MESSAGE_TO_SEND = os.getenv("MESSAGE_TO_SEND", default="ping")

ISSUER_TYPE = os.getenv("ISSUER_TYPE", default="acapy")
VERIFIER_TYPE = os.getenv("VERIFIER_TYPE", default="acapy")
...
if RAW_OOB_BOOL == "False":
    ...
    OOB_INVITE = bool(os.getenv("OOB_INVITE", default=False))
